...
const SECTIONS: Section[] = [
  ...
  },
  {
    ...
    items: [
      {
        q: "입금 대기란?",
        a: "게스트가 예약을 완료했지만 아직 입금 전인 상태입니다. 설정한 자동취소 시간이 지나면 자동으로 취소됩니다.",
      },
      {
        q: "입금확인요청이란?",
        a: "게스트가 입금 후 직접 확인 요청을 보낸 상태입니다. 호스트가 실제 입금을 확인하고 '예약 확정' 버튼을 눌러야 합니다. 이 상태에서는 자동취소가 되지 않으므로 호스트가 직접 확정 또는 취소 처리해야 합니다.",
      },
      {
        q: "자동취소란?",
        a: "게스트가 예약 후 입금확인요청을 보내지 않은 채 자동취소 시간(기본 1시간)이 지나면 시스템이 자동으로 취소합니다. 단, 입금확인요청 상태에서는 자동취소가 발생하지 않습니다. 응답 불가 시간대에는 타이머가 멈춥니다.",
      },
      {
        q: "취소된 예약은 어떻게 처리되나요?",
    ...
    items: [
      {
        ...
        a: "설정 탭에서 30분 / 1시간 / 3시간 / 6시간 / 24시간 중 선택할 수 있습니다. 입금 대기 상태에만 적용되며, 입금확인요청 상태에서는 자동취소가 되지 않습니다.",
      },
      {
        q: "응답 불가 시간이란?",
    ...
    items: [
      {
        ...
        a: "숙소 이름, 주소, 대표 이미지, 단축 링크(슬러그), 입금 계좌(은행명·계좌번호·예금주 모두 필수), 객실 정보(이미지·요금 포함), 이용 유의사항이 필요합니다. 모두 입력해야 게시할 수 있습니다.",
      },
      {
        q: "게시중 / 비노출이란?",
      ...
      },
      {
        ...
        a: "네. 숙소별로 각각 등록해야 합니다. 등록된 숙소가 여러 개라면 모든 숙소에 유의사항이 있어야 게시중으로 전환할 수 있습니다. 하나라도 미등록 숙소가 있으면 체크리스트가 완료되지 않습니다.",
      },
      {
        q: "객실별 개별 유의사항이란?",
  ...
  },
  {
    ...
    items: [
      ...
      {
        q: "예약 알림은 어떻게 받나요?",
        a: "카카오톡 알림톡으로 예약 생성·입금확인요청 시 알림이 전송됩니다. 알림을 받으려면 사용 중인 카카오 계정의 알림톡 수신이 허용되어 있어야 합니다. 예약 내역은 호스트 페이지의 '예약관리' 탭에서 확인할 수 있으며, '예약알림'과 '예약현황' 두 가지 보기를 제공합니다.",
      },
      {
        q: "문의는 어디서 하나요?",
    ...
    <div className="min-h-screen bg-gray-50">
      <header className="bg-white">
        <div className="max-w-2xl mx-auto px-4 py-2 flex items-center justify-between">
          ...
          <Link href="/host" className="text-xs text-gray-400 hover:text-gray-600 transition-colors">마이페이지 →</Link>
        </div>
      </header>
