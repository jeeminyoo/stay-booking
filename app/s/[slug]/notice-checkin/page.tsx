...
export default function NoticeCheckinPage() {
  ...
  const isPerRoom = property.notice_checkin_per_room ?? false;
  ...
  const noticeText = isPerRoom
    ? (targetRoom?.notice_checkin ?? "")
    : (property.notice_checkin ?? "");
      ...
      <main className="max-w-2xl mx-auto px-4 py-8">
        <div className="mb-6">
          <div className="flex items-center gap-2 mb-1">
            ...
            <h1 className="text-2xl font-black text-gray-900">체크인 당일 안내</h1>
          </div>
